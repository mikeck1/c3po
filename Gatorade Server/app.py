...
UPLOAD_FOLDER = '/Users/Michael/Desktop/School/c3po local/Py2Mongo/server2/temp'
...
def index():
    ...
    return render_template('home.html',butts=butts)
        ...
        if request.form['btn'] == 'Submit' and form.validate():
            ...
            if request.form['btn'] == 'Upload':
                ...
                if file and allowed_file(file.filename):
                    ...
                    while not os.path.exists('/temp/'+filename):
                        time.sleep(1)
